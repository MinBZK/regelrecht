...
Een werksessie van een dagdeel met CJIB, het VORIJK-team, Eelco en mij. Agenda: bovenstaande tabel rij voor rij doorlopen, de pilot kiezen, knelpunten benoemen. Daarna kan RFC-019 in de RegelRecht-repo van Proposed naar Accepted, en kunnen we de eerste wet (Wahv of alternatief) als machine-leesbare regeling in het corpus opnemen. Pilot levert dan een werkende producer-pad én een fixture die laat zien hoe een burger zijn vordering kan natrekken tot op het wetsartikel.
...
- [RFC-019: RegelRecht × MBO](https://docs.regelrecht.rijks.app/rfcs/rfc-019): technische uitwerking van dit voorstel
