...
//
// Lokaal draait hij op `/`, achter het poc-portaal op
// `/nieuwkomersbekostiging/`. Vite zet `import.meta.env.BASE_URL` op wat er in
// `base` staat (met een afsluitende slash), dus dat is de enige plek waar het
// pad vandaan komt.
//
