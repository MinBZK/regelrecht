...
## Externe override die wel doorwerkt — juridische nuance

Niet onderdeel van art 26 zelf, maar aangehaald voor volledigheid:

| Override | Bron | Doel | Effect |
|---|---|---|---|
| `overrides:` op URI art 12 auto-drempel | Leidraad Invordering 2008 art 26.2.3 (rijks) | `auto_als_vermogen` | Auto-drempel wordt €3.350 i.p.v. URI's €2.269 |

### ⚠ Juridische twijfel over grondslag (workshop beslispunt B8)

**Leidraad Invordering 2008 geldt formeel voor rijksbelastingen.** Waterschapsbelastingen vallen daar niet onder. HHNK krijgt URI 1990 via **Regeling kwijtschelding belastingen medeoverheden** (RKBM) art 1, maar die verwijst alléén naar URI (ministeriële regeling) — niet naar rijks-beleidsregels zoals Leidraad 2008.

HHNK-leidraad 2026 aanhef bepaalt:
> *"Bij de opmaak van deze leidraad is aansluiting gezocht bij de Leidraad Invordering 2008 van de Rijksoverheid. Het betreft echter geen kopie. Daar waar noodzakelijk zijn bepalingen opgenomen die afwijken van de Rijksleidraad."*

→ De HHNK-grondslag voor €3.350 is **niet** directe rijks-doorwerking, maar **beleidsmatige aansluiting** via deze aanhef-verklaring.

**Discrepantie YAML ↔ juridische werkelijkheid**:
- YAML laat Leidraad 2008 blind overrulen op elke URI art 12-aanroep, ook in HHNK-context
- Uitkomst klopt toevallig (HHNK volgt Leidraad 2008 beleidsmatig)
- Maar juridisch komt de €3.350 bij HHNK binnen via andere route dan de YAML suggereert

### Drie mogelijke oplossingen (B8)

| Optie | Wat | Voor-/nadeel |
|---|---|---|
| **rijks-override** | Huidige situatie laten, grondslag via HHNK-aanhef claimen | Minste onderhoud; juridisch halve leugen in YAML |
| **HHNK-eigen-override** | HHNK-leidraad krijgt eigen override op URI art 12 naast rijks-override | Dubbele formule, expliciete grondslag per scope |
| **beide met scope-voorwaarde** | Rijks-override voor rijksbelastingen; HHNK-eigen voor waterschapsbelastingen | Zuiver juridisch, meest onderhoud |

**Review**:

- ☐ B8 antwoord: welke optie (rijks-override / HHNK-eigen / beide)?
- ☐ Bij eigen override: welke legal_basis? *"HHNK-leidraad 2026 aanhef: beleidsmatige aansluiting bij Leidraad 2008"*?
- ☐ Deze override is **het enige** voorbeeld in onze keten — maar toekomstige rijks-beleidswijzigingen kunnen hetzelfde probleem geven. Proces voor mede-overheid-doorwerking definiëren?

### Algemene lering

Dit is een **tekenend voorbeeld** van waar AI-vertaling te kort door de bocht gaat: de overrride werkt mechanisch, maar de juridische grondslag voor doorwerking op medeoverheden vergt expliciete beleidsmatige aansluiting. Zie workshop-md beslispunt B8.
