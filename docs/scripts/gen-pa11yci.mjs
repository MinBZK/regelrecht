...
const config = {
  defaults: {
    ...
    //  - nldd-page-footer-legal-bar-item: the new page-footer family
    //    (0.8.47) renders the © text with a token that axe scores as
    //    sub-AA — also a design-system concern, to be fixed upstream.
    hideElements:
      '.pagefind-ui, svg[id^="mermaid-"], pre.astro-code, #rr-hero-title, .rr-hero nldd-rich-text p, nldd-code-viewer, nldd-page-footer-legal-bar-item',
  },
