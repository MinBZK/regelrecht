...
```yaml
# corpus/context/nl/holidays/feestdagen.yaml
id: nl_feestdagen
name: Nederlandse feestdagen
description: Holiday calendar for the Algemene termijnenwet
...
- [Algemene termijnenwet](https://wetten.overheid.nl/BWBR0002488) — canonical example of context dependency: names holidays without stating their dates
