---
title: "Phased Implementation (Gefaseerde Inwerkingtreding)"
description: "How the harvester handles laws that come into force in phases. Resolved, kept as background on the problem and the approach."
---
