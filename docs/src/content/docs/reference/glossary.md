...
|-------|---------|-------------|
| **Grondwet** | Constitution | Supreme law of the Netherlands |
| **Wet** | Act / Law | Formal legislation passed by Parliament (Staten-Generaal) |
| **Algemene Maatregel van Bestuur (AMvB)** | Order in Council | Regulation by the Crown (government + King) |
| **Ministeriële regeling** | Ministerial regulation | Regulation issued by a minister |
| **Verordening** | Ordinance | Local regulation by municipalities or provinces |
...
| **Beroep** | Appeal | Court appeal against an objection decision |
| **Belanghebbende** | Interested party | Person whose interests are directly affected |
...
| Term | Description |
|------|-------------|
| **Corpus Juris** | The git-versioned collection of all machine-readable Dutch laws |
| **Machine-readable** | The executable interpretation of a law article |
| **Open term** | A value in a higher law that is filled by a lower regulation |
| **Implements** | A lower regulation declaring it fills open terms of a higher law |
| **Cross-law reference** | A law referencing outputs from another law via `source` |
