...
3. **Graaf**: per wet de bronnen, de invoer uit andere wetten en de uitvoer, met lijnen naar de leverende wet en de waarden van de persona erop; het profiel kiest de wetten van het verhaal (`graph_laws`), de zijbalk laat wetten aan- en uitzetten.
