...
A [marked construct](./markings) taints the whole result, wherever it appears. Dropping the tainted elements and combining the rest would produce a number that looks complete and is not.
