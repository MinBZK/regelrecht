...
2. **Valid redirect URIs**: add exactly `http://localhost:7300/auth/callback`
   ...
   editor's Harvester section, reached through the editor-api proxy, so it needs
