...
|---------|-----|-------------|
| Editor | http://localhost:3000 | Law editor + harvester **Beheer** section (hot reload) |
| Admin API | http://localhost:8000 | Harvester REST API (auto-recompile; UI is the editor's Beheer section) |
