...
2. **Fill in the frontmatter.**
   ...
   authors:
     - name: Your Name         # optional — a role on its own is fine
       role: your role
   summary: >-
     One or two sentences. This is what the overview page shows.
   tags:                       # optional
     - a-tag
