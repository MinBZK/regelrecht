...
wetten die naar v0.7.0 gaan dragen een markering waar zij een untranslatable
...
claim vallen dat de sprong van v0.5.6 naar v0.7.0 additief is.
...
- Schema v0.7.0: `schema/v0.7.0/schema.json`, `markings` en `open_terms` in
