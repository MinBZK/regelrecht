...
depends_on:
  ...
  - RFC-012 (Untranslatables, superseded by this RFC)
...
- [RFC-012: Untranslatables](/rfcs/rfc-012), het kanaal onder zijn oude naam en het gedrag van de engine
...
**In de docs:** [Markings](/concepts/markings).
