...
- **The most recent version of any law is treated as valid forever.** A law can only "end" by being
  superseded - never by expiring or being repealed.[Mariette: terminologie: regulation ipv. law? Sommige zaken gelden ook voor gedelegeerde regelingen, niet alleen voor formele wetten.]
- **Real laws do end without a successor**, in two ways:
  - *intrinsic* - the law's own horizonbepaling: CEK23 "*vervalt met ingang van 1 januari 2027*"
    (artikel 15, tweede lid, Tijdelijk besluit eenmalig bedrag ouderen van Surinaamse herkomst);
  - *extrinsic* - another instrument ends it: the Wet op de openluchtrecreatie is gefaseerd
    ingetrokken per 1 januari 2008; [Mariette: dit is mi. niet extrinsic. De wet is gewijzigd en er is een nieuw artikel 44 in opgenomen dat zegt: Deze wet vervalt op 1 januari 2008. Omdat dat nieuwe artikel bij inwerkingtreding van de wijzigingswet integraal onderdeel wordt van de wet, bepaalt hij zelf zijn vervaldatum; zie https://zoek.officielebekendmakingen.nl/stb-2005-308.html.] the Tijdelijke wet maatregelen covid-19 verviel per 20 mei 2022 after the
    Eerste Kamer rejected the goedkeuringswet for the fifth verlenging (17 mei 2022, dossier 36042). [Mariette: dit is een bijzonder geval, het gaat om goedkeuring bij wet van een koninklijk besluit, misschien even vermelden. Zie https://wetten.overheid.nl/jci1.3:c:BWBR0044337&artikel=VIII&z=2022-03-15&g=2022-03-15. Een mooi voorbeeld is wel artikel 2.1 Aanvullingswet bodem Omgevingswet, waarin de Wet bodembescherming wordt ingetrokken (https://wetten.overheid.nl/jci1.3:c:BWBR0043277&hoofdstuk=2&paragraaf=2.1&artikel=2.1&z=2024-01-01&g=2024-01-01).] 
- **Dependents break silently ("verweesde regelingen").** A regulation whose delegation basis
  disappears can no longer have effect (old Aanwijzing 243: *van rechtswege vervallen*). Example: the Tijdelijke regeling maatregelen covid-19 was vervallen per the same date as the Twm covid-19. In regelrecht's `source.regulation` model this is a dangling reference: the engine keeps computing on no-longer-valid law - a **silent wrong answer**.
Since 2018 Aanwijzing 6.24 prescribes explicit mede-intrekking instead. Example: Besluit van 5 oktober 2018, houdende vaststelling van het tijdstip van inwerkingtreding van een artikel van de Wet dieren alsmede tot het doen vervallen van een artikel van de Gezondheids- en welzijnswet voor dieren en het intrekken van het Fokkerijbesluit en de Fokkerijregeling (Stb. 2018, 362 ). 
...
|---|---|---|
| Subsidieregeling bekostiging plafond energietarieven kleinverbruikers 2023 (CEK23) | [BWBR0047628](https://wetten.overheid.nl/BWBR0047628) | intrinsic end (art. 8.1 lid 2); worked example A; real corpus law | [Mariette: ik kon deze in eerste instantie niet vinden in wetten.nl, vandaar het nieuwe voorbeeld hierboven. Hoeft dus niet overgenomen, maar wel even de naam van de regeling noemen in de originele tekst hierboven] 
| Wet op de openluchtrecreatie | [BWBR0006548](https://wetten.overheid.nl/BWBR0006548) · [EK 29.829](https://www.eerstekamer.nl/wetsvoorstel/29829_gefaseerde_intrekking_wet_op) | extrinsic end: whole wet ingetrokken per 1-1-2008 | [Mariette: naar mijn idee gaat het hier om 'article repeal'. De wet zelf vervalt maar één keer, nl. op 1 januari 2008 (zie de Staatsbladversie in https://www.eerstekamer.nl/behandeling/20050623/publicatie_wet/document3/f=/w29829st.pdf].
...
| Aanwijzingen voor de regelgeving 6.24/6.25 (old 243) | [BWBR0005730](https://wetten.overheid.nl/BWBR0005730) | drafting conventions for vervallen/intrekking (besluit van de Minister-President, not substantive law) | [Mariette: De Ar zijn een ministeriële regeling, bindend voor ambtenaren, maar ze hebben geen externe werking; is dat laatste wat bedoeld is met not substantive?] 
...
- **Two provenance modes** for the date:
  - *intrinsic* - the law's own vervalbepaling (CEK23 art. 8.1 lid 2). The only mode RFC-019
    implements.
  - *extrinsic* - the date comes from another instrument (intrekkings/vervalwet, intrekkings/verval-KB, or open: [Mariette: intrekken en vervallen zijn verschillende dingen, misschien is het 'technisch' geen verschil, maar in de wetgeving wel (vervallen is van rechtswege, intrekken is een expliciete handeling).]
...
- **The staartzin is eerbiedigende werking** - the RFC-020 bridge case: after it ends, the regulation stays
  applicable to subsidies granted before January, 1, 2027. `valid_to` correctly
...
- **The end date is not in the law.** Art. VIII lid 1: the inserted Hoofdstuk Va Wet publieke gezondheid *vervalt*
...
- The clean, grounded *intrinsic* case is CEK23 (example A): one literal vervaldatum for the whole
  regeling.
  [Mariette: Zie nog een wat minder specifiek geval in deze categorie hierboven, wellicht hier ook toevoegen.]
