...
[Mariette: als ik de afstemmingsverordening zoek, krijg ik alleen versies die vervallen zijn per 1-1-2011 (hij zit ook niet in het regelregister van Amsterdam). Wat de verordening regelde ziet eruit als uitwerking van de opdracht uit artikel 8 Participatiewet (verlagen bijstand). Het is een dan een implement, toch? En wellicht een ander voorbeeld kiezen?]
...
[Mariette: ik denk dat we hier een link kunnen leggen met een metanormmodel (soort toplevel juridische grammatica) waar ik met Vincent van Dijk en Marco Brattinga aan werk.] 
...
- type: Annotation
  ...
  body:
    - type: TextualBody
      value: >-
        ...
        Dienst Toeslagen policy register.
      purpose: questioning
      format: text/plain
      language: en
    - type: TextualBody
  ...
  workflow: open
```
[Mariette: punt is nog wel dat beleidsregels vele gedaanten aannemen en ook namen hebben (zie Besluit bestuursrecht Toeslagen, Beleidsregel bestuurlijke boeten Dienst Toeslagen bv.). Heeft Toeslagen verder een policy register? De engine kan vast met andere naamgeving omgaan, maar het is wel een organisatorische vraag hoe je het regelbestand (op alle niveaus beter op orde krijgt (ook in een byo scenario).]
...
ambiguity:
  - id: open-norm-not-filled
    ...
    description: "An open norm whose implementing text has not been enacted and published."
  - id: open-norm-partial
    label: "Open norm, deels ingevuld"
    description: "An open norm whose implementing text has been partially enacted and published; some parts still unresolved."
[Mariette: is open norm hetzelfde als het eerder gebruikte open term? Verder: ik ga ervan uit dat invullingen (dus uitvoeringsbeleid) op enigerlei wijze moeten zijn vastgesteld en gepubliceerd; dat geldt ook voor het uitvoeringsbeleid dat hierna wordt genoemd.]
  - id: needs-uitvoeringsbeleid
    label: "Behoeft invulling door uitvoeringsbeleid"
...
- [Glossary of Dutch Legal Terms](https://docs.regelrecht.rijks.app/reference/glossary)
