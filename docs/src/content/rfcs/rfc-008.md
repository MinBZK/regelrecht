      ...
      - name: BEHANDELING
        ...
        requires:
          - name: beslistermijn_start
            type: date
        # Awb 4:13: beslistermijn is "redelijke termijn", typically 8 weeks [Mariette: 4:13 zegt 'beslistermijn is bij wettelijk voorschrift vastgestelde termijn' (dus in lex specialis). Als die ontbreekt is het 'redelijke termijn' (8 weken na ontvangst aanvraag of mededeling dat beslistermijn niet haalbaar is (4:14, derde lid), daar zit dus ook nog een keuze in. Zijn hiervoor nog specifieke patronen nodig?] 
