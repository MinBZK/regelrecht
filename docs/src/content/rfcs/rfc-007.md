...
**Lex specialis.** Awb 6:7 says "de termijn bedraagt zes weken", no exception clause, no delegation. Yet the Vreemdelingenwet artikel 69, eerste lid, says "in afwijking van artikel 6:7 bedraagt de bezwaartermijn vier weken." It unilaterally replaces the value. This differs from IoC delegation ([RFC-003](/rfcs/rfc-003)): the general law does not know it is being overridden. [Mariette: ik zou de link met delegatie hier niet leggen, daarbij wordt de wet nl. sws niet 'overridden' maar verder uitgewerkt. Gedelegeerde regels kunnen in principe juist niet afwijken van de wet (tenzij die dat expliciet toestaat)] 
...
[Mariette: het Gelet op artikel... is mi. problematisch (zie ook opmerking bij RFC-003). In aanvulling daarop: "Gelet op" staat niet in het lichaam van de regeling (de artikelen), maar in de aanhef. In doorlopende teksten op wetten.nl staat alleen de aanhef van de originele regeling; als die gewijzigd is op grond van een nieuwe delegatiegrondslag, is die dus niet zichtbaar.] 
...
### Full YAML examples
[Mariette: algemene opm: als een bepaald lid van een artikel relevant is, dan dat ook benoemen (bv. artikel 6:8 Awb en 69 Vw bevatten nog meer regels over termijnen dan de hier gemodelleerde.] 
