...
```
[Mariette: de typen regelingen in de national default zijn niet per se steeds lager in rank (een gemeentelijke verordening is niet lager dan een provinciale, het zijn eigenlijk 'wetten' op een ander bestuursniveau). Ik weet niet of het veel uitmaakt voor de werking, maar wel goed om in het oog te houden. Ook van belang dat bestuursorganen niet de vrijheid hebben om 'any open term' in te vullen als een delegatie-regel ontbreekt, juist niet... (geldt mi. ook voor layered override hieronder) Wmb. iets om te bespreken.] 
