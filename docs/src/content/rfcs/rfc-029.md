...
De sprong v0.5.6 naar v0.7.0 is niet additief. Hij voegt `placement`,
...
graafindex documenten onder schema 0.7.0 niet opneemt, omdat ze de velden missen
...
`$schema`. De sprong v0.5.6 naar v0.7.0 voldoet; de andere elf zijn ongecontroleerd.
...
- Van de twaalf schema-overgangen heb ik er één gediffed (v0.5.6 naar v0.7.0).
