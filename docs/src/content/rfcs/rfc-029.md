...
`open_term` draagt in plaats van te zijn weggelaten.
...
is dat niet genoeg, en ronde 3 heeft dat aangetoond op een manier die de moeite
van het vastleggen waard is.
...
Die laatste teller vroeg een correctie die het noemen waard is, omdat hij de
faalvorm blootlegt. In de eerste versie telde een declaratie als haar eigen
...
Dat verschil is precies de losse restrictie die de juridische review aanwees:
