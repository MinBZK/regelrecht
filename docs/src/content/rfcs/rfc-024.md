...
The modeling question is narrow: **a law YAML must express the rounding and precision that is prescribed in the regulation or in execution policy.** As with [RFC-023](/rfcs/rfc-023), the starting point is the legislative
