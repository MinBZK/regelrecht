...
The modeling question is narrow: **a law YAML must express the rounding and precision that the law
text prescribes.** As with [RFC-023](/rfcs/rfc-023), the starting point is the legislative
...
- [RFC-012: Markings](/rfcs/rfc-012): the rounding untranslatable this RFC resolves
