...
`untranslatable` niet welke waarden hij blokkeert. Zo'n document kan de kanten
en de markeringen die de graaf nodig heeft niet dragen.
...
Schema 0.6.0 draagt daarvoor drie dingen die 0.5.6 niet heeft: `placement` als
