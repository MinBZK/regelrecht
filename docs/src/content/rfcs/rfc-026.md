...
scoperegel, `norm_gaps` als eigen kanaal naast `untranslatables`, en `declares`
voor het artikel dat een documenteigenschap vaststelt in plaats van iets te
berekenen. Die laatste kwam erbij toen bleek dat het corpus vrijwel geen
