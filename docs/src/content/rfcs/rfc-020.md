...
- **Eerbiedigende werking**: the old law stays applicable to existing cases
  ...
  example A). [Mariette: eerbiedigende werking is niet de enige vorm van overgangsrecht, terugwerkende kracht is dat ook; hier ook noemen/uitwerken?]
- **Statische verwijzing** (Aanwijzing 3.47): a static reference freezes the text
  ...
  "*zoals zij op een gegeven tijdstip luidden*". [Mariette: dynamische verwijzing is niet uitgewerkt. Lijkt me logisch, maar dan ook niet noemen.]
...
|---|---|---|
| Awb art. 7:11 (heroverweging) | [BWBR0005537](https://wetten.overheid.nl/BWBR0005537) | lid 1: "*Indien het bezwaar ontvankelijk is, vindt op grondslag daarvan een heroverweging van het bestreden besluit plaats.*" (example A) | [Mariette: dit gaat niet over de geldigheid van de wet, maar over effect van bezwaar (daarvan slaat op 'bezwaar'). Of mis ik iets?]
...
original *besluit* moment (ex tunc) is selected by which event date is passed as `as_of`: [Mariette: dit is toch afhankelijk van wat (in dit geval) de Vw regelt, niet wat 7:11 bepaalt, zie overweging 6.2.3 Greenpeace-uitspraak: Wat betreft het geldende recht of beleid, betekent dit dat het bestuursorgaan zich bij een wijziging van dat recht of beleid ten tijde van de heroverweging rekenschap moet geven van eventueel overgangsrecht of een in het beleid opgenomen overgangsregel.]
