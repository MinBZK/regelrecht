...
- tier 2 coverage: every lid has machine-readable logic, an explicit skip reason or an untranslatable, plus the lexical trigger scan over the connectives. This single cheap check, with no model involved, would have caught the Awb 4:13 case.
