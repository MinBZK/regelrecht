...
A consumer asking for a voided output gets an explicit failure, never a number. That is intended: an amount the law does not recognise must not be passed on silently.
