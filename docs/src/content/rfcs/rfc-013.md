...
```json
{
  ...
  "scope": {
    "sources": [
      ...
      {
        "id": "amsterdam", [Mariette: wat doet amsterdam hier? Die heeft geen bevoegdheid in het kader van de zorgtoeslag; ik zou minvws-dentral (voor Wet op de zorgtoeslag) en minfin-central (voor Awir) verwachten] 
        "ref": "main@abc1234",
...
```
[Mariette: artikel 2, tweede lid, Wtz noemt wel toetsingsinkomen, maar zegt niet wat het is...].
...
```
[Mariette: Ik denk dat je hier naar artikel 21, onderdeel e, Awr zou moeten verwijzen, dus authentiek inkomensgegeven zoals vastgesteld/legd door de inspecteur in de BRI. De Wtz regelt niet duidelijk wat het toetsingsinkomen is, maar de site van Toeslagen geeft wel heel duidelijk aan dat het ofwel het verzamelinkomen is, ofwel als dat er (nog) niet is, het belastbaar loon op jaarbasis. Artikel 2.18 is maar een deel van het verhaal. Overigens vreemd dat de Wtz toetsingsinkomen niet definieert (of ik moet er heel erg langs kijken...] 
...
```
[Mariette: de bezwaartermijn van vier weken komt toch juist uit de Vreemdelingenwet, niet uit artikel 6:7 Awb? 
