---
id: verkenning-publicatievoorziening
titel: Verkenning publicatievoorziening
faseId: wat-fase-2
...
toelichting: |-
  ...
  Deze verkenning gebeurt met een prototype van de publicatievoorziening dat invulling geeft aan de antwoorden op onderstaande onderzoeksvragen.
volgorde: 2000
onderzoeksvragen:
  - vraag: Wat publiceer je doel & wat is de status van de publicatie?
    paper: sec:legalstatus
  - vraag: Wie kan en mag wat doen met de publicaties?
    paper: sec:whochooses
  - vraag: In welke vorm(en) mag er worden gepubliceerd?
    paper: sec:format
  - vraag: Wat is er nodig zodat bevoegde gezagen kunnen publiceren?
    paper: sec:ownership
  ...
  - vraag: >-
      ...
      (het met terugwerkende kracht aanpassen van regels die in het verleden
      golden)?
    paper: sec:ownership
  - vraag: >-
      Hoe gaan we om met inconsistenties wanneer verschillende instanties
      (bijv. 300 gemeenten) een verschillende versie van dezelfde regel
      publiceren?
    paper: sec:ownership
  - vraag: >-
      Welke juridische status hebben onafhankelijke monitors die deze
