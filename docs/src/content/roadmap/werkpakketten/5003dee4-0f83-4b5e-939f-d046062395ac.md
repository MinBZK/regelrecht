...
toelichting: |-
  ...
  **Voorlopige Definition of Done** (werkhypothese bij de vraag wanneer de
  ...
  - De regels hebben een validatieprocedure doorlopen en de validiteit van de
    implementatie is vastgesteld. De attestatiekant daarvan, de vorm waarin
    een interpretatiebeslissing wordt vastgelegd, wordt uitgewerkt in
    [PR #1362](https://github.com/MinBZK/regelrecht/pull/1362).
