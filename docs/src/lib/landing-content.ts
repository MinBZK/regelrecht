...
export const content: Record<'nl' | 'en', LandingContent> = {
  nl: {
    ...
    signup: {
      ...
      errEmailEmpty: 'Een e-mailadres, zodat we je updates kunnen sturen en contact kunnen opnemen',
      errEmailInvalid: 'Een e-mailadres met een @ en een punt',
      errName: 'Je volledige naam, zodat we weten wie zich aanmeldt',
  ...
  en: {
    ...
    signup: {
      ...
      errEmailEmpty: 'An email address, so we can send you updates and get in touch',
      errEmailInvalid: 'An email address with an @ and a dot',
      errName: 'Your full name, so we know who is signing up',
