...
async function initEngine() {
  ...
  initPromise = (async () => {
    try {
      // Dynamic path prevents the bundler from resolving at build time.
      // The WASM pkg is generated by `just wasm-build` and may not exist
      // during Docker builds where only the editor (without WASM) is built.
