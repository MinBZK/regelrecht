...
// Roles that may reach the harvester-admin "Beheer" section. Any harvester-*
          ...
          <nldd-toolbar size="md">
            ...
            <nldd-toolbar-item slot="end">
              ...
              <nldd-menu id="settings-menu-md" anchor="settings-menu-btn-md">
                ...
                <nldd-menu-item v-if="canViewBeheer" text="Beheer" icon="gear" @click.stop="goToBeheer"></nldd-menu-item>
                <nldd-menu-divider v-if="canViewBeheer"></nldd-menu-divider>
