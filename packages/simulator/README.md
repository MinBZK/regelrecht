...
| draagt | de uitkomsten, de inputs met hun herkomst, het receipt, het schema van de verplichtingen, de hooks die niet draaiden | wat er bij de bekendmaking ingevuld is en wat een hook uit het besluit las (als inputs), de uitkomsten van de hooks op die stage en van de eigen regeling met hun artikel, de hooks die niet draaiden, en de termijnen die nu pas gaan lopen |
