...
export const LAW_ENTRY_COLUMNS = [
  ...
  { key: 'law_name', label: 'Name', sortable: true, width: 'stretch' },
...
export const JOB_COLUMNS = [
  ...
  { key: '_error', label: 'Error', sortable: false, width: 'stretch' },
...
export const GROUPED_COLUMNS = [
  { key: 'law_id', label: 'Law ID', sortable: true, width: 'stretch' },
