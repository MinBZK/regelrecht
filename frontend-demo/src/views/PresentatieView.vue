  ...
  <nldd-page>
    <nldd-simple-section width="720px">
      ...
      <nldd-container padding="0" gap="8">
        ...
        <nldd-rich-text spacing="tight">
          <p v-if="state.presentationMode === 'zaal'">De dia's van het verhaal vullen het scherm. Zodra een dia de demo opent, verdwijnen ze en is het scherm van de demo. Bladeren gaat gewoon door; <kbd>Shift</kbd>+<kbd>P</kbd> haalt ze terug.</p>
