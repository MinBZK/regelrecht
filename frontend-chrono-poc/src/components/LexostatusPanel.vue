...
import LexostatusValues from './LexostatusValues.vue';
...
<template>
  <nldd-container layout="stack" gap="16">
    ...
    <template v-if="answer">
      ...
      <!-- De uitkomsten, als lijst en waar ze uit regels bestaan als tabel.
           Dezelfde weergave als op de pagina inzicht in je aanvraag. -->
      <LexostatusValues v-if="answer.established" :answer="answer" />
