...
// "Achter de schermen": de testopstelling in één pagina, zoals ze er stond
// voordat er een aanvraagportaal naast kwam. De werkbalk en het ophalen van het
// beeld zitten in App.vue; deze pagina tekent het hoofdpaneel en de tijdlijn,
// als twee panelen van de split view daarboven.
//
