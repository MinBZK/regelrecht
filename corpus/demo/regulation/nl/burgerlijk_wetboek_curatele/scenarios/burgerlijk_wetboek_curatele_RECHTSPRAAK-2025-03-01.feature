...
Feature: Burgerlijk Wetboek Curatele (BW 1:378-391)
  ...
  Scenario: Curator heeft actieve curatele voor curandus
    ...
    And the following "RECHTSPRAAK" data with key "bsn" for law "burgerlijk_wetboek_curatele":
      ...
      | 400000001 | [{"bsn_curandus":"500000001","naam_curandus":"Sophie van Dam","datum_ingang":"2022-01-15","datum_einde":"","status":"ACTIEF"}] |
      | 500000001 | []                                                                                                                             |
  ...
  Scenario: Beeindigde curatele met status BEEINDIGD geeft geen delegaties
    ...
    And the following "RECHTSPRAAK" data with key "bsn" for law "burgerlijk_wetboek_curatele":
      | bsn       | curatele_registraties                                                                                                                    |
      | 400000007 | [{"bsn_curandus":"500000009","naam_curandus":"Jan de Boer","datum_ingang":"2020-01-01","datum_einde":"2023-12-31","status":"BEEINDIGD"}] |
      | 500000009 | []                                                                                                                                       |
  ...
  Scenario: Curatele met einddatum in het verleden geeft geen delegaties
    ...
    And the following "RECHTSPRAAK" data with key "bsn" for law "burgerlijk_wetboek_curatele":
      | bsn       | curatele_registraties                                                                                                                    |
      | 400000001 | [{"bsn_curandus":"500000001","naam_curandus":"Sophie van Dam","datum_ingang":"2020-01-01","datum_einde":"2024-12-31","status":"ACTIEF"}] |
      | 500000001 | []                                                                                                                                       |
    When I evaluate outputs "voldoet_aan_voorwaarden, heeft_delegaties, subject_ids" of "burgerlijk_wetboek_curatele"
    Then output "voldoet_aan_voorwaarden" is true
    And output "heeft_delegaties" is false
  ...
  Scenario: Curator met meerdere curandussen heeft meerdere delegaties
    ...
    And the following "RECHTSPRAAK" data with key "bsn" for law "burgerlijk_wetboek_curatele":
      | bsn       | curatele_registraties                                                                                                                                                                                                                                    |
      | 400000001 | [{"bsn_curandus":"500000001","naam_curandus":"Sophie van Dam","datum_ingang":"2022-01-15","datum_einde":"","status":"ACTIEF"},{"bsn_curandus":"500000010","naam_curandus":"Pieter Zwak","datum_ingang":"2023-06-01","datum_einde":"","status":"ACTIEF"}] |
      | 500000001 | []                                                                                                                                                                                                                                                       |
      | 500000010 | []                                                                                                                                                                                                                                                       |
    When I evaluate outputs "voldoet_aan_voorwaarden, heeft_delegaties" of "burgerlijk_wetboek_curatele"
    Then output "voldoet_aan_voorwaarden" is true
  ...
  Scenario: Mix van actieve en beeindigde curatele
    ...
    And the following "RECHTSPRAAK" data with key "bsn" for law "burgerlijk_wetboek_curatele":
      | bsn       | curatele_registraties                                                                                                                                                                                                                                                 |
      | 400000001 | [{"bsn_curandus":"500000001","naam_curandus":"Sophie van Dam","datum_ingang":"2022-01-15","datum_einde":"","status":"ACTIEF"},{"bsn_curandus":"500000009","naam_curandus":"Jan de Boer","datum_ingang":"2020-01-01","datum_einde":"2023-12-31","status":"BEEINDIGD"}] |
      | 500000001 | []                                                                                                                                                                                                                                                                    |
      | 500000009 | []                                                                                                                                                                                                                                                                    |
    When I evaluate outputs "voldoet_aan_voorwaarden, heeft_delegaties" of "burgerlijk_wetboek_curatele"
    Then output "voldoet_aan_voorwaarden" is true
    And output "heeft_delegaties" is true
    # POC: output "subject_ids" contains 500000001 (array membership not expressible in the canonical grammar)
    # POC: output "subject_ids" does not contain 500000009 (negative membership not expressible in the canonical grammar)

  Scenario: Curatele met toekomstige einddatum is nog actief
    Given parameter "bsn" is "400000001"
    And the following "RECHTSPRAAK" data with key "bsn" for law "burgerlijk_wetboek_curatele":
      | bsn       | curatele_registraties                                                                                                                    |
      | 400000001 | [{"bsn_curandus":"500000001","naam_curandus":"Sophie van Dam","datum_ingang":"2022-01-15","datum_einde":"2026-12-31","status":"ACTIEF"}] |
      | 500000001 | []                                                                                                                                       |
    When I evaluate outputs "voldoet_aan_voorwaarden, heeft_delegaties" of "burgerlijk_wetboek_curatele"
    Then output "voldoet_aan_voorwaarden" is true
    And output "heeft_delegaties" is true
