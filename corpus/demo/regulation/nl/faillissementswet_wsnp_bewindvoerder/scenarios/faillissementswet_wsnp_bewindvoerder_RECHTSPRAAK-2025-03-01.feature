...
Feature: Faillissementswet WSNP Bewindvoerder (Fw Titel III)
  ...
  Scenario: WSNP bewindvoerder heeft actieve schuldsanering
    ...
    And the following "RECHTSPRAAK" data with key "bsn" for law "faillissementswet_wsnp_bewindvoerder":
      ...
      | 400000005 | [{"bsn_saniet":500000007,"naam_saniet":"Sandra Meijer","insolventie_nummer":"R.18/23/789","datum_uitspraak":"2023-09-01","datum_einde":"","status":"ACTIEF"}] |
      | 500000007 | []                                                                                                                                                            |
    ...
    # POC: output "subject_ids" contains 500000007 (array membership not expressible in the canonical grammar)
  ...
  Scenario: Voltooide WSNP met schone lei - bewindvoerder heeft geen actieve delegaties meer
    ...
    And the following "RECHTSPRAAK" data with key "bsn" for law "faillissementswet_wsnp_bewindvoerder":
      | bsn       | wsnp_registraties                                                                                                                                                           |
      | 400000005 | [{"bsn_saniet":500000007,"naam_saniet":"Sandra Meijer","insolventie_nummer":"R.18/23/789","datum_uitspraak":"2023-09-01","datum_einde":"2025-02-01","status":"SCHONE_LEI"}] |
      | 500000007 | []                                                                                                                                                                          |
    When I evaluate outputs "voldoet_aan_voorwaarden, heeft_delegaties, subject_ids" of "faillissementswet_wsnp_bewindvoerder"
    Then output "voldoet_aan_voorwaarden" is true
    And output "heeft_delegaties" is false
  ...
  Scenario: WSNP beeindigd zonder schone lei
    ...
    And the following "RECHTSPRAAK" data with key "bsn" for law "faillissementswet_wsnp_bewindvoerder":
      | bsn       | wsnp_registraties                                                                                                                                                          |
      | 400000005 | [{"bsn_saniet":500000007,"naam_saniet":"Sandra Meijer","insolventie_nummer":"R.18/23/789","datum_uitspraak":"2023-09-01","datum_einde":"2024-06-15","status":"BEEINDIGD"}] |
      | 500000007 | []                                                                                                                                                                         |
    When I evaluate outputs "voldoet_aan_voorwaarden, heeft_delegaties, subject_ids" of "faillissementswet_wsnp_bewindvoerder"
    Then output "voldoet_aan_voorwaarden" is true
    And output "heeft_delegaties" is false
  ...
  Scenario: Bewindvoerder heeft meerdere actieve WSNP-zaken
    ...
    And the following "RECHTSPRAAK" data with key "bsn" for law "faillissementswet_wsnp_bewindvoerder":
      | bsn       | wsnp_registraties                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
      | 400000005 | [{"bsn_saniet":500000007,"naam_saniet":"Sandra Meijer","insolventie_nummer":"R.18/23/789","datum_uitspraak":"2023-09-01","datum_einde":"","status":"ACTIEF"},{"bsn_saniet":500000008,"naam_saniet":"Pieter Probleem","insolventie_nummer":"R.18/24/123","datum_uitspraak":"2024-03-15","datum_einde":"","status":"ACTIEF"},{"bsn_saniet":500000009,"naam_saniet":"Maria Moeilijk","insolventie_nummer":"R.18/24/456","datum_uitspraak":"2024-06-01","datum_einde":"","status":"ACTIEF"}] |
      | 500000007 | []                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
      | 500000008 | []                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
      | 500000009 | []                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
    When I evaluate outputs "voldoet_aan_voorwaarden, heeft_delegaties" of "faillissementswet_wsnp_bewindvoerder"
    ...
    # POC: output "subject_ids" contains 500000009 (array membership not expressible in the canonical grammar)

  Scenario: Mix van actieve en voltooide WSNP-zaken - alleen actieve tellen mee
    Given parameter "bsn" is "400000005"
    And the following "RECHTSPRAAK" data with key "bsn" for law "faillissementswet_wsnp_bewindvoerder":
      | bsn       | wsnp_registraties                                                                                                                                                                                                                                                                                                                         |
      | 400000005 | [{"bsn_saniet":500000007,"naam_saniet":"Sandra Meijer","insolventie_nummer":"R.18/23/789","datum_uitspraak":"2023-09-01","datum_einde":"2025-02-01","status":"SCHONE_LEI"},{"bsn_saniet":500000008,"naam_saniet":"Pieter Probleem","insolventie_nummer":"R.18/24/123","datum_uitspraak":"2024-03-15","datum_einde":"","status":"ACTIEF"}] |
      | 500000007 | []                                                                                                                                                                                                                                                                                                                                        |
      | 500000008 | []                                                                                                                                                                                                                                                                                                                                        |
    When I evaluate outputs "voldoet_aan_voorwaarden, heeft_delegaties" of "faillissementswet_wsnp_bewindvoerder"
    Then output "voldoet_aan_voorwaarden" is true
    And output "heeft_delegaties" is true
    # POC: output "subject_ids" contains 500000008 (array membership not expressible in the canonical grammar)
    # POC: output "subject_ids" does not contain 500000007 (negative membership not expressible in the canonical grammar)

  Scenario: WSNP met einddatum in de toekomst is nog actief
    Given parameter "bsn" is "400000005"
    And the following "RECHTSPRAAK" data with key "bsn" for law "faillissementswet_wsnp_bewindvoerder":
      | bsn       | wsnp_registraties                                                                                                                                                       |
      | 400000005 | [{"bsn_saniet":500000007,"naam_saniet":"Sandra Meijer","insolventie_nummer":"R.18/23/789","datum_uitspraak":"2023-09-01","datum_einde":"2025-09-01","status":"ACTIEF"}] |
      | 500000007 | []                                                                                                                                                                      |
    When I evaluate outputs "voldoet_aan_voorwaarden, heeft_delegaties" of "faillissementswet_wsnp_bewindvoerder"
    Then output "voldoet_aan_voorwaarden" is true
    And output "heeft_delegaties" is true
