...
Feature: Burgerlijk Wetboek Mentorschap (BW 1:450-462)
  ...
  Scenario: Mentor heeft actief mentorschap
    ...
    And the following "RECHTSPRAAK" data with key "bsn" for law "burgerlijk_wetboek_mentorschap":
      ...
      | 400000001 | [{"bsn_betrokkene":"500000003","naam_betrokkene":"Willem Jansen","datum_ingang":"2023-06-15","datum_einde":"","status":"ACTIEF"}] |
      | 500000003 | []                                                                                                                                |
  ...
  Scenario: Beeindigd mentorschap geeft geen actieve delegaties
    ...
    And the following "RECHTSPRAAK" data with key "bsn" for law "burgerlijk_wetboek_mentorschap":
      | bsn       | mentorschap_registraties                                                                                                                       |
      | 400000001 | [{"bsn_betrokkene":"500000003","naam_betrokkene":"Willem Jansen","datum_ingang":"2023-06-15","datum_einde":"2024-12-31","status":"BEEINDIGD"}] |
      | 500000003 | []                                                                                                                                             |
  ...
  Scenario: Mentor met meerdere betrokkenen
    ...
    And the following "RECHTSPRAAK" data with key "bsn" for law "burgerlijk_wetboek_mentorschap":
      | bsn       | mentorschap_registraties                                                                                                                                                                                                                                               |
      | 400000001 | [{"bsn_betrokkene":"500000003","naam_betrokkene":"Willem Jansen","datum_ingang":"2023-06-15","datum_einde":"","status":"ACTIEF"},{"bsn_betrokkene":"500000004","naam_betrokkene":"Anna Hulpbehoevend","datum_ingang":"2024-01-01","datum_einde":"","status":"ACTIEF"}] |
      | 500000003 | []                                                                                                                                                                                                                                                                     |
      | 500000004 | []                                                                                                                                                                                                                                                                     |
    When I evaluate outputs "voldoet_aan_voorwaarden, heeft_delegaties" of "burgerlijk_wetboek_mentorschap"
    Then output "voldoet_aan_voorwaarden" is true
  ...
  Scenario: Mentor met mix van actief en beeindigd mentorschap
    ...
    And the following "RECHTSPRAAK" data with key "bsn" for law "burgerlijk_wetboek_mentorschap":
      | bsn       | mentorschap_registraties                                                                                                                                                                                                                                                            |
      | 400000001 | [{"bsn_betrokkene":"500000003","naam_betrokkene":"Willem Jansen","datum_ingang":"2023-06-15","datum_einde":"","status":"ACTIEF"},{"bsn_betrokkene":"500000004","naam_betrokkene":"Anna Hulpbehoevend","datum_ingang":"2022-01-01","datum_einde":"2024-06-30","status":"BEEINDIGD"}] |
      | 500000003 | []                                                                                                                                                                                                                                                                                  |
      | 500000004 | []                                                                                                                                                                                                                                                                                  |
    When I evaluate outputs "voldoet_aan_voorwaarden, heeft_delegaties" of "burgerlijk_wetboek_mentorschap"
    Then output "voldoet_aan_voorwaarden" is true
    And output "heeft_delegaties" is true
    # POC: output "subject_ids" contains 500000003 (array membership not expressible in the canonical grammar)
    # POC: output "subject_ids" does not contain 500000004 (negative membership not expressible in the canonical grammar)
    # POC: output "subject_names" contains Willem Jansen (array membership not expressible in the canonical grammar)
  ...
  Scenario: Mentorschap met einddatum in de toekomst is nog actief
    ...
    And the following "RECHTSPRAAK" data with key "bsn" for law "burgerlijk_wetboek_mentorschap":
      | bsn       | mentorschap_registraties                                                                                                                    |
      | 400000001 | [{"bsn_betrokkene":"500000003","naam_betrokkene":"Willem Jansen","datum_ingang":"2023-06-15","datum_einde":"2026-12-31","status":"ACTIEF"}] |
      | 500000003 | []                                                                                                                                          |
    When I evaluate outputs "voldoet_aan_voorwaarden, heeft_delegaties" of "burgerlijk_wetboek_mentorschap"
    Then output "voldoet_aan_voorwaarden" is true
    And output "heeft_delegaties" is true
