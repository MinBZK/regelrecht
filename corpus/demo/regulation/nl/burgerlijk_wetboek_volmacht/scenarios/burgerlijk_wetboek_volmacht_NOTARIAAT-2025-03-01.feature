...
Feature: Burgerlijk Wetboek Volmacht (BW 3:60-79)
  ...
  Scenario: Gevolmachtigde heeft actieve algemene volmacht
    ...
    And the following "NOTARIAAT" data with key "bsn" for law "burgerlijk_wetboek_volmacht":
      ...
      | 400000002 | [{"bsn_volmachtgever":"500000004","naam_volmachtgever":"Elisabeth van den Berg-Smit","volmacht_type":"ALGEMENE_VOLMACHT","datum_ingang":"2021-05-01","datum_einde":"","status":"ACTIEF","is_herroepen":false}] |
      | 500000004 | []                                                                                                                                                                                                             |
  ...
  Scenario: Gevolmachtigde heeft actieve bijzondere volmacht
    ...
    And the following "NOTARIAAT" data with key "bsn" for law "burgerlijk_wetboek_volmacht":
      | bsn       | volmacht_registraties                                                                                                                                                                                            |
      | 400000002 | [{"bsn_volmachtgever":"500000004","naam_volmachtgever":"Elisabeth van den Berg-Smit","volmacht_type":"BIJZONDERE_VOLMACHT","datum_ingang":"2021-05-01","datum_einde":"","status":"ACTIEF","is_herroepen":false}] |
      | 500000004 | []                                                                                                                                                                                                               |
    When I evaluate outputs "voldoet_aan_voorwaarden, heeft_delegaties" of "burgerlijk_wetboek_volmacht"
    Then output "voldoet_aan_voorwaarden" is true
    And output "heeft_delegaties" is true
  ...
  Scenario: Herroepen volmacht geeft geen bevoegdheid
    ...
    And the following "NOTARIAAT" data with key "bsn" for law "burgerlijk_wetboek_volmacht":
      | bsn       | volmacht_registraties                                                                                                                                                                                         |
      | 400000002 | [{"bsn_volmachtgever":"500000004","naam_volmachtgever":"Elisabeth van den Berg-Smit","volmacht_type":"ALGEMENE_VOLMACHT","datum_ingang":"2021-05-01","datum_einde":"","status":"ACTIEF","is_herroepen":true}] |
      | 500000004 | []                                                                                                                                                                                                            |
    When I evaluate outputs "voldoet_aan_voorwaarden, heeft_delegaties, subject_ids" of "burgerlijk_wetboek_volmacht"
    Then output "voldoet_aan_voorwaarden" is true
    And output "heeft_delegaties" is false
  ...
  Scenario: Inactieve volmacht geeft geen bevoegdheid
    ...
    And the following "NOTARIAAT" data with key "bsn" for law "burgerlijk_wetboek_volmacht":
      | bsn       | volmacht_registraties                                                                                                                                                                                            |
      | 400000002 | [{"bsn_volmachtgever":"500000004","naam_volmachtgever":"Elisabeth van den Berg-Smit","volmacht_type":"ALGEMENE_VOLMACHT","datum_ingang":"2021-05-01","datum_einde":"","status":"INACTIEF","is_herroepen":false}] |
      | 500000004 | []                                                                                                                                                                                                               |
    When I evaluate outputs "voldoet_aan_voorwaarden, heeft_delegaties" of "burgerlijk_wetboek_volmacht"
    Then output "voldoet_aan_voorwaarden" is true
    And output "heeft_delegaties" is false
  ...
  Scenario: Verlopen volmacht geeft geen bevoegdheid
    ...
    And the following "NOTARIAAT" data with key "bsn" for law "burgerlijk_wetboek_volmacht":
      | bsn       | volmacht_registraties                                                                                                                                                                                                    |
      | 400000002 | [{"bsn_volmachtgever":"500000004","naam_volmachtgever":"Elisabeth van den Berg-Smit","volmacht_type":"ALGEMENE_VOLMACHT","datum_ingang":"2021-05-01","datum_einde":"2024-12-31","status":"ACTIEF","is_herroepen":false}] |
      | 500000004 | []                                                                                                                                                                                                                       |
    When I evaluate outputs "voldoet_aan_voorwaarden, heeft_delegaties" of "burgerlijk_wetboek_volmacht"
    Then output "voldoet_aan_voorwaarden" is true
    And output "heeft_delegaties" is false
  ...
  Scenario: Volmacht met toekomstige einddatum is nog actief
    ...
    And the following "NOTARIAAT" data with key "bsn" for law "burgerlijk_wetboek_volmacht":
      | bsn       | volmacht_registraties                                                                                                                                                                                                    |
      | 400000002 | [{"bsn_volmachtgever":"500000004","naam_volmachtgever":"Elisabeth van den Berg-Smit","volmacht_type":"ALGEMENE_VOLMACHT","datum_ingang":"2021-05-01","datum_einde":"2026-12-31","status":"ACTIEF","is_herroepen":false}] |
      | 500000004 | []                                                                                                                                                                                                                       |
    When I evaluate outputs "voldoet_aan_voorwaarden, heeft_delegaties" of "burgerlijk_wetboek_volmacht"
    Then output "voldoet_aan_voorwaarden" is true
    And output "heeft_delegaties" is true
  ...
  Scenario: Gevolmachtigde met meerdere volmachten van verschillende volmachtgevers
    ...
    And the following "NOTARIAAT" data with key "bsn" for law "burgerlijk_wetboek_volmacht":
      | bsn       | volmacht_registraties                                                                                                                                                                                                                                                                                                                                                                                          |
      | 400000002 | [{"bsn_volmachtgever":"500000004","naam_volmachtgever":"Elisabeth van den Berg-Smit","volmacht_type":"ALGEMENE_VOLMACHT","datum_ingang":"2021-05-01","datum_einde":"","status":"ACTIEF","is_herroepen":false},{"bsn_volmachtgever":"600000006","naam_volmachtgever":"Jan de Vries","volmacht_type":"BIJZONDERE_VOLMACHT","datum_ingang":"2022-01-15","datum_einde":"","status":"ACTIEF","is_herroepen":false}] |
      | 500000004 | []                                                                                                                                                                                                                                                                                                                                                                                                             |
      | 600000006 | []                                                                                                                                                                                                                                                                                                                                                                                                             |
    When I evaluate outputs "voldoet_aan_voorwaarden, heeft_delegaties" of "burgerlijk_wetboek_volmacht"
    Then output "voldoet_aan_voorwaarden" is true
    And output "heeft_delegaties" is true
    # POC: output "subject_ids" contains 500000004 (array membership not expressible in the canonical grammar)
    # POC: output "subject_ids" contains 600000006 (array membership not expressible in the canonical grammar)
    # POC: output "delegation_types" contains GEVOLMACHTIGDE_ALGEMEEN (array membership not expressible in the canonical grammar)
    # POC: output "delegation_types" contains GEVOLMACHTIGDE_BIJZONDER (array membership not expressible in the canonical grammar)
  ...
  Scenario: Gevolmachtigde met een actieve en een herroepen volmacht
    ...
    And output "heeft_delegaties" is true
    # POC: output "subject_ids" contains 500000004 (array membership not expressible in the canonical grammar)
    # POC: output "subject_ids" does not contain 600000006 (negative membership not expressible in the canonical grammar)
