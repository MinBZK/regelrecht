...
Feature: Burgerlijk Wetboek Beschermingsbewind (BW 1:431-449)
  ...
  Scenario: Bewindvoerder heeft actief volledig bewind voor rechthebbende
    ...
    And the following "RECHTSPRAAK" data with key "bsn" for law "burgerlijk_wetboek_beschermingsbewind":
      ...
      | 400000001 | [{"bsn_rechthebbende":"500000002","naam_rechthebbende":"Bart Willems","bewind_type":"VOLLEDIG_BEWIND","datum_ingang":"2023-03-01","datum_einde":"","status":"ACTIEF"}] |
      | 500000002 | []                                                                                                                                                                     |
    ...
    # POC: output "subject_ids" contains 500000002 (array membership not expressible in the canonical grammar)
  ...
  Scenario: Bewindvoerder met meerdere rechthebbenden
    ...
    And the following "RECHTSPRAAK" data with key "bsn" for law "burgerlijk_wetboek_beschermingsbewind":
      | bsn       | bewind_registraties                                                                                                                                                                                                                                                                                                                                    |
      | 400000001 | [{"bsn_rechthebbende":"500000002","naam_rechthebbende":"Bart Willems","bewind_type":"VOLLEDIG_BEWIND","datum_ingang":"2023-03-01","datum_einde":"","status":"ACTIEF"},{"bsn_rechthebbende":"500000003","naam_rechthebbende":"Maria Hulpbehoevend","bewind_type":"GEDEELTELIJK_BEWIND","datum_ingang":"2024-01-15","datum_einde":"","status":"ACTIEF"}] |
      | 500000002 | []                                                                                                                                                                                                                                                                                                                                                     |
      | 500000003 | []                                                                                                                                                                                                                                                                                                                                                     |
    When I evaluate outputs "voldoet_aan_voorwaarden, heeft_delegaties" of "burgerlijk_wetboek_beschermingsbewind"
    Then output "voldoet_aan_voorwaarden" is true
    And output "heeft_delegaties" is true
    # POC: output "subject_ids" contains 500000002 (array membership not expressible in the canonical grammar)
    # POC: output "subject_ids" contains 500000003 (array membership not expressible in the canonical grammar)
    # POC: output "subject_names" contains Bart Willems (array membership not expressible in the canonical grammar)
  ...
  Scenario: Persoon is geen bewindvoerder - geen registraties
    Given parameter "bsn" is "600000001"
    And the following "RECHTSPRAAK" data with key "bsn" for law "burgerlijk_wetboek_beschermingsbewind":
      | bsn       | bewind_registraties                                                                                                                                                    |
      | 600000001 | []                                                                                                                                                                     |
      | 400000001 | [{"bsn_rechthebbende":"500000002","naam_rechthebbende":"Bart Willems","bewind_type":"VOLLEDIG_BEWIND","datum_ingang":"2023-03-01","datum_einde":"","status":"ACTIEF"}] |
  ...
  Scenario: Bewind is beeindigd door datum_einde in het verleden
    ...
    And the following "RECHTSPRAAK" data with key "bsn" for law "burgerlijk_wetboek_beschermingsbewind":
      | bsn       | bewind_registraties                                                                                                                                                              |
      | 400000001 | [{"bsn_rechthebbende":"500000002","naam_rechthebbende":"Bart Willems","bewind_type":"VOLLEDIG_BEWIND","datum_ingang":"2023-03-01","datum_einde":"2024-12-31","status":"ACTIEF"}] |
      | 500000002 | []                                                                                                                                                                               |
  ...
  Scenario: Bewind is beeindigd door status BEEINDIGD
    ...
    And the following "RECHTSPRAAK" data with key "bsn" for law "burgerlijk_wetboek_beschermingsbewind":
      | bsn       | bewind_registraties                                                                                                                                                       |
      | 400000001 | [{"bsn_rechthebbende":"500000002","naam_rechthebbende":"Bart Willems","bewind_type":"VOLLEDIG_BEWIND","datum_ingang":"2023-03-01","datum_einde":"","status":"BEEINDIGD"}] |
      | 500000002 | []                                                                                                                                                                        |
    When I evaluate outputs "voldoet_aan_voorwaarden, heeft_delegaties, subject_ids" of "burgerlijk_wetboek_beschermingsbewind"
    Then output "voldoet_aan_voorwaarden" is true
    And output "heeft_delegaties" is false
  ...
  Scenario: Bewind met toekomstige einddatum is nog actief
    ...
    And the following "RECHTSPRAAK" data with key "bsn" for law "burgerlijk_wetboek_beschermingsbewind":
      | bsn       | bewind_registraties                                                                                                                                                              |
      | 400000001 | [{"bsn_rechthebbende":"500000002","naam_rechthebbende":"Bart Willems","bewind_type":"VOLLEDIG_BEWIND","datum_ingang":"2023-03-01","datum_einde":"2026-12-31","status":"ACTIEF"}] |
      | 500000002 | []                                                                                                                                                                               |
    When I evaluate outputs "voldoet_aan_voorwaarden, heeft_delegaties" of "burgerlijk_wetboek_beschermingsbewind"
    Then output "voldoet_aan_voorwaarden" is true
    And output "heeft_delegaties" is true
  ...
  Scenario: Gedeeltelijk bewind - beperkt tot specifieke goederen
    ...
    And the following "RECHTSPRAAK" data with key "bsn" for law "burgerlijk_wetboek_beschermingsbewind":
      | bsn       | bewind_registraties                                                                                                                                                       |
      | 400000001 | [{"bsn_rechthebbende":"500000004","naam_rechthebbende":"Jan Beperkt","bewind_type":"GEDEELTELIJK_BEWIND","datum_ingang":"2024-06-01","datum_einde":"","status":"ACTIEF"}] |
      | 500000004 | []                                                                                                                                                                        |
    When I evaluate outputs "voldoet_aan_voorwaarden, heeft_delegaties" of "burgerlijk_wetboek_beschermingsbewind"
    Then output "voldoet_aan_voorwaarden" is true
    And output "heeft_delegaties" is true
    # POC: output "subject_ids" contains 500000004 (array membership not expressible in the canonical grammar)
    # POC: output "delegation_types" contains BEWINDVOERDER (array membership not expressible in the canonical grammar)
  ...
  Scenario: Combinatie van actief en beeindigd bewind
    ...
    And the following "RECHTSPRAAK" data with key "bsn" for law "burgerlijk_wetboek_beschermingsbewind":
      | bsn       | bewind_registraties                                                                                                                                                                                                                                                                                                                                         |
      | 400000001 | [{"bsn_rechthebbende":"500000002","naam_rechthebbende":"Bart Willems","bewind_type":"VOLLEDIG_BEWIND","datum_ingang":"2020-01-01","datum_einde":"2022-12-31","status":"BEEINDIGD"},{"bsn_rechthebbende":"500000005","naam_rechthebbende":"Anna Actief","bewind_type":"GEDEELTELIJK_BEWIND","datum_ingang":"2024-01-01","datum_einde":"","status":"ACTIEF"}] |
      | 500000002 | []                                                                                                                                                                                                                                                                                                                                                          |
      | 500000005 | []                                                                                                                                                                                                                                                                                                                                                          |
    When I evaluate outputs "voldoet_aan_voorwaarden, heeft_delegaties" of "burgerlijk_wetboek_beschermingsbewind"
    Then output "voldoet_aan_voorwaarden" is true
    And output "heeft_delegaties" is true
    # POC: output "subject_ids" contains 500000005 (array membership not expressible in the canonical grammar)
    # POC: output "subject_ids" does not contain 500000002 (negative membership not expressible in the canonical grammar)
  ...
  Scenario: Bewind ingegaan voor peildatum is actief
    ...
    And the following "RECHTSPRAAK" data with key "bsn" for law "burgerlijk_wetboek_beschermingsbewind":
      | bsn       | bewind_registraties                                                                                                                                                    |
      | 400000001 | [{"bsn_rechthebbende":"500000006","naam_rechthebbende":"Kees Vandaag","bewind_type":"VOLLEDIG_BEWIND","datum_ingang":"2024-06-15","datum_einde":"","status":"ACTIEF"}] |
      | 500000006 | []                                                                                                                                                                     |
    When I evaluate outputs "voldoet_aan_voorwaarden, heeft_delegaties" of "burgerlijk_wetboek_beschermingsbewind"
    Then output "voldoet_aan_voorwaarden" is true
    And output "heeft_delegaties" is true
  ...
  Scenario: Bewind met einddatum na peildatum is nog actief
    ...
    And the following "RECHTSPRAAK" data with key "bsn" for law "burgerlijk_wetboek_beschermingsbewind":
      | bsn       | bewind_registraties                                                                                                                                                              |
      | 400000001 | [{"bsn_rechthebbende":"500000007","naam_rechthebbende":"Lisa Vandaag","bewind_type":"VOLLEDIG_BEWIND","datum_ingang":"2023-01-01","datum_einde":"2026-06-01","status":"ACTIEF"}] |
      | 500000007 | []                                                                                                                                                                               |
    When I evaluate outputs "voldoet_aan_voorwaarden, heeft_delegaties" of "burgerlijk_wetboek_beschermingsbewind"
    Then output "voldoet_aan_voorwaarden" is true
    And output "heeft_delegaties" is true
