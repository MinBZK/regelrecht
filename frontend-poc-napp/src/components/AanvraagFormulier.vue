...
const titel = computed(() => `Subsidie aanvragen voor ${registratie.value?.subsidiejaar ?? '…'}`);
</script>
...
<template>
  ...
  <nldd-simple-section>
    <nldd-title id="aanvraag-titel" size="2">
      <h2>{{ titel }}</h2>
    </nldd-title>
