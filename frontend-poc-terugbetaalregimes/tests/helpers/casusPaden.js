...
// `frontend-poc-terugbetaalregimes/` en de inhoud in
// `corpus-poc/terugbetaalregimes/`.
//
...
/** De app zelf (frontend-poc-terugbetaalregimes/). */
export const appRoot = resolve(__dirname, '..', '..');

/** De casus-inhoud (corpus-poc/terugbetaalregimes/). */
export const casusRoot = resolve(appRoot, '..', 'corpus-poc', 'terugbetaalregimes');
